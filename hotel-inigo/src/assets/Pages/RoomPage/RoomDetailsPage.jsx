...
const RoomDetailsPage = ({ isOpen, onClose, roomname }) => {
  ...
  const currentRoom = RoomDataDetails.find(
    (room) => normalize(room.title) === normalize(roomname)
  );
              ...
              >
                {currentRoom.images.map((image, index) => (
                  <SwiperSlide key={index}>
                    <img
                      src={image}
                      alt={`${currentRoom.title} view ${index + 1}`}
                    />
                  </SwiperSlide>
                ))}
              </Swiper>
                ...
                <div className="room-title-container">
                  ...
                  <div className="room-price">
                    <p>
                      ...
                      {currentRoom.price.toLocaleString()}/Night
                    </p>
                  </div>
                </div>
              ...
              <div className="main-container">
                <div className="left-container">
                  <div className="details-section">
                    ...
                    <div className="features-grid">
                      {currentRoom.facilities.map((feature, index) => (
                ...
                {/* <div className="details-section">
                    ...
                    <div className="facilities-grid">
                      {currentRoom.todelete.map((facility, index) => (
