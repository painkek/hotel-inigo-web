...
const BookingPage = () => {
  ...
  const validateForm = () => {
    ...
    const guestCount = parseInt(
      showCustomGuestInput ? formData.customGuests : formData.guests,
      10
    );
  ...
  const handleSubmit = async (e) => {
    ...
    const finalData = {
      ...formData,
      guests: showCustomGuestInput ? formData.customGuests : formData.guests,
    };
    try {
  ...
  const ContactIcons = {
    email: (
      <MdEmail size={20} style={{ marginRight: 8, verticalAlign: "middle" }} />
    ),
    phone: (
      <FaPhone size={20} style={{ marginRight: 8, verticalAlign: "middle" }} />
    ),
    address: (
      <FaMapMarkedAlt
        size={20}
    ...
    <div className="booking-page">
      ...
      <div className="hero-section">
        ...
        <div className="hero-content">
          <h1>Book Now</h1>
          <p>
            Book your stay in seconds! Get the best price when you book
            directly.
          </p>
        </div>
      </div>
          ...
          <div className="booking-form-container">
            ...
            {bookingSuccess ? (
              <div className="success-message">
                ...
                <p>
                  Thank you {formData.firstName}! Your reservation is submitted
                </p>
                <p>
                  We'll contact you within 24 hours to finalize your
                  reservation.
                </p>
              </div>
            ) : (
              <form className="booking-form" onSubmit={handleSubmit} noValidate>
                  ...
                  {["firstName", "lastName"].map((field) => (
                    <div className="form-group" key={field}>
                      ...
                      {validationErrors[field] && (
                        <span className="error-message" id={`${field}-error`}>
                          {validationErrors[field]}
                        </span>
                      )}
                    </div>
                ...
                <div className="form-group">
                  ...
                  <input
                    ...
                    aria-describedby={
                      validationErrors.age ? "age-error" : undefined
                    }
                  />
                ...
                <div className="form-group guests-group">
                  ...
                  <select
                    ...
                    aria-describedby={
                      validationErrors.guests ? "guests-error" : undefined
                    }
                  >
        ...
        <div className="hotel-details-container">
          <div className="hotel-details">
            <div className="contact-info">
              ...
              {["email", "phone", "address"].map((type) => (
                ...
                >
                  ...
                  <div>
                    {Array.isArray(locationData?.[type]) &&
                      locationData[type].map((item, i) => (
              ...
              <div className="social-media">
                <div className="social-icons">
                  {Array.isArray(locationData?.socialMedia) &&
                    locationData.socialMedia.map(({ name, url }, index) => (
                      <a
                        href={url}
                        key={index}
            ...
            <div className="map-container">
              ...
              <div className="map">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3885.34004611773!2d123.7451972748961!3d13.140937787190234!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a1037b4af9c243%3A0x705c53a9e51aa3d1!2sHotel%20Inigo!5e0!3m2!1sen!2sph!4v1747122658832!5m2!1sen!2sph"
                  width="300"
                  height="300"
                  style={{ border: 0 }}
                  allowFullScreen
